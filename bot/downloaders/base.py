...
class DownloadOptions:
    ...
    # Use simple 'best' format for maximum compatibility with all platforms
    # and authentication states (cookies). Filesize check is done after metadata extraction.
    # Avoid [filesize<50M] filter as it excludes formats without size metadata.
