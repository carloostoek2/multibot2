    ...
    async def download(
        ...
        def _download():
            ...
            try:
                ...
                # Instagram verifies cookies match the User-Agent.
                # Use Chrome headers matching the same browser yt-dlp impersonates
                # so Instagram doesn't redirect to login.
                config.set(("extractor", "instagram"), "headers", {
                    "User-Agent": (
